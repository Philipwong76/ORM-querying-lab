...
def problem_three(request):
  ...
  for course in courses:
      print(
         f'Instructor name: {course.instructor.first_name} {course.instructor.last_name} Courses: {course.name} ')
...
def problem_five(request):
  ...
  student = Student.objects.create(first_name="Kyle", last_name="Harwood", gpa=3.0, year=2022)
  print(
            f' Id: {student.id} Full name: {student.first_name} {student.last_name} Year: {student.year} GPA: {student.gpa}')
  return complete(request)
...
def problem_six(request):
    ...
    student_id = Student.objects.get(id = 11)
    print(f' Id: {student_id.id} Full name: {student_id.first_name} {student_id.last_name} GPA: {student_id.gpa}')
    return complete(request)
